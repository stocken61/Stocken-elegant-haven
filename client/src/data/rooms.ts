...
export const rooms: Room[] = [
  {
    ...
    category: 'standard',
    name: 'Economy Zimmer',
    shortDescription: 'Unser gemütliches Economy Zimmer bietet alles, was Sie für einen angenehmen Aufenthalt benötigen. Mit Blick auf den Garten.',
    description: 'Unser gemütliches Economy Zimmer bietet Ihnen alles, was Sie für einen angenehmen Aufenthalt benötigen.',
    extendedDescription: 'Das Economy Zimmer ist mit hochwertigen Materialien ausgestattet und verbindet traditionelles Schweizer Design mit modernem Komfort. Das luxuriöse Queen-Size-Bett verspricht erholsamen Schlaf nach einem Tag in der Natur.',
    price: 180,
    capacity: 2,
    size: 25,
    bed: 'Queen-Bett',
