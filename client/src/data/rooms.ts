...
export const rooms: Room[] = [
  ...
  // Premium Suite (1 Suite, 28 m²)
  {
    ...
    name: 'Premium',
    shortDescription: 'Unsere Premium Suite mit 28 m² - ein Doppelbett und ein Schlafsofa',
  ...
  // Premium Family Suite (1 Suite, größer)
  {
    ...
    name: 'Family',
    shortDescription: 'Unsere Familien-Suite mit 49 m² - zwei Doppelbetten und ein Schlafsofa',
