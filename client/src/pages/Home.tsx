  ...
  return (
    <>
      ...
      <section className="rooms-preview py-16 bg-neutral-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold text-center text-neutral-dark mb-10 section-heading">
            Unsere Zimmer
          </h2>
      ...
      <section className="contact-preview py-16 bg-neutral-light">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-start">
            <div className="lg:w-1/2 p-6">
              <h2 className="text-3xl font-serif font-bold text-neutral-dark mb-6 section-heading">
